...
public abstract class EasyIn
{
    ...
    //exactly the same as getString() but accepts a String "msg" and prints it through the console.
    ...
    //exactly the same as getInt() but accepts a String "msg" and prints it through the console.
    public static int getIntWithMsg(String msg)
    {
	int i = 0;
	boolean ok = false;
	String s;
